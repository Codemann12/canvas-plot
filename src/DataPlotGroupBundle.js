(function (global, factory) {
  ...
  var bisectRight$4 = ascendingBisect$4.right;
  ...
  var map$6 = array$7.map;
  var slice$9 = array$7.slice;
  ...
  function continuous(deinterpolate, reinterpolate) {
    ...
    scale.domain = function(_) {
      return arguments.length ? (domain = map$6.call(_, number$6), rescale()) : domain.slice();
    };
    ...
    scale.rangeRound = function(_) {
      return range = slice$9.call(_), interpolate$$1 = interpolateRound, rescale();
    };
  ...
  exports.CanvasDataPlotGroup = CanvasDataPlotGroup;
