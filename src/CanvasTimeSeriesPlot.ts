...
export class CanvasTimeSeriesPlot{
    ...
    addDataSet (uniqueID: string, label: string, dataSet: Array<{xDate: Date, yNum: number}>, colorString: string, updateDomains: boolean, copyData?: boolean): void{
